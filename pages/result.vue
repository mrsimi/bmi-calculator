<template>
  <div class="container mx-auto pt-6 px-4 max-w-lg">
    <p class="text-4xl font-bold mb-4 text-center">Your Result</p>
    <div class="rounded bg-gray-700 p-6 text-center">
      <p class="text-green-400 font-bold uppercase">{{result.label}}</p>
      <p class="text-6xl font-bold text-center">{{bmi || "27"}}</p>
      ...
      if(navigator.share){
        navigator 
          .share({
            ...
            text: "Checkout how to code a BMI calculator",
            url: 'https://dev.to/fayazara/let-s-code-a-dribble-design-with-vue-js-tailwindcss-working-demo-part-1-of-2-3h9'
          })
          .then(() => console.log("Successful share"))
          .catch(error => console.log("Error sharing", error));
      }else{
        alert("Sharing is not allowed on this device")
      }
    }
  },
  computed: {

<template>
  <div class="container mx-auto pt-6 px-4 max-w-lg">
    ...
    <button @click="calculateBMI" class="bg-superpink font-bold uppercase p-4 fixed w-full bottom-0 left-0"> Calculate your Bmi </button>
  </div>
</template>
...
import ageweight from '~/components/home/age-weight.vue';
